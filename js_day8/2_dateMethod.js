...
//Thu Mar 17 2022 10:34:48 GMT+0900 (대한민국 표준시)  , 요일 월 일 년도 시:분:초 GMT(그리니치천문대)+또는-시간
//날짜 시간 지정 : 년도 월 일 (단, 월 0~11 입니다.)
...
console.log(today.getDay()) //요일 결과 확인해 보세요 : 0(일)~6(토)
...
//출생일에서 3000일 기념일
let mybirth = new Date(2003,12,0)      //내 생일 : 2003 12 07
...
//필요한 값으로 배열을 만들고 join 메소드로 연결시켜 문자열 생성 (연결기코는 없으므로 '')
console.log([year,month2,date2].join(''))
console.log([year,month2,date2].join('-'))
//기억하기 : 배열 -> 문자열로 join , 문자열 -> 배열로 split

console.log(new Date('2022-03-03'))
console.log(new Date('2022-03-06') - new Date('2022-03-03')) //결과는 타임스탬프 값
...
console.log(diff/oneday_timestamp)  // 두 날짜 간격을 '일'로 구합니다